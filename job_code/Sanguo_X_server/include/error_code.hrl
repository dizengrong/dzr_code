...
-define(ERR_SKILL_NOT_EXIST,				12089).		%% 没有技能书中的技能
...
-define(ERR_TALENT_FULL, 				15005).			%% 武将可提升天赋已满
...
%% -define(GUILD_ERROR_MEMBER_OVERFLOW,		19003).			%% 公会成员数量超出
...
%% -define(GUILD_ERROR_DONATE_SILVER_OVERFLOW,19017).		%% 捐献的银币超出限额
...
%% 聊天
-define(ERR_CAN_NOT_CHAT,         16003). %% 禁言
