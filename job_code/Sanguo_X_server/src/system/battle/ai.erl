...
-module(ai).
-include("common.hrl").
-export([get_skill_by_ai/3, validate_skill/3, get_skill_target/3]).
...
% target handling
%============================================================================================================
get_skill_target(SkillId, Src, BattleData) ->
	?INFO(ai, "SkillId = ~w", [SkillId]),
	Skill = data_skill_table:get(SkillId div 1000, 1),
