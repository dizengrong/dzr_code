...
%%%
%%% @end
%%% Created : 28 Jun 2010 by Liangliang <>
%%%-------------------------------------------------------------------
...
make_log_file() ->
	...
	lists:concat(["/data/logs/",AgentName,"_",ServerName,"/cqzj_all_",Year, "_",
				  common_tool:one_to_two(Month), "_", common_tool:one_to_two(Day), "___",common_tool:one_to_two(Hour),".log"]).
