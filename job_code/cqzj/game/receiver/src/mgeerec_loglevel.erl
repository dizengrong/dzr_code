...
set(Loglevel) when is_integer(Loglevel) ->
    try
        {Mod,Code} = dynamic_compile:from_string(mgeerec_logger_src(Loglevel)),
...
%% very efficient code.
mgeerec_logger_src(Loglevel) ->
    L = integer_to_list(Loglevel),
    "-module(mgeerec_logger).
