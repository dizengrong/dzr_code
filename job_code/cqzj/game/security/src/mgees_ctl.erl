...
-spec init() -> 'ok'.
init() ->
    ets:new(mgees_ctl_cmds, [named_table, set, public]),
    ets:new(mgees_ctl_host_cmds, [named_table, set, public]),
    ok.
...
process(["status"]) ->
    ...
    case lists:keysearch(mgees, 1, application:which_applications()) of
        false ->
