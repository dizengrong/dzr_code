...
%%% Created : 2010-10-9
%%% -------------------------------------------------------------------
-module(mod_role_all_rank).

-include("mgeew.hrl").


-export([
         send_role_all_ranking_info/1
        ]).
...
%%                            {ranking_jingjie,<<"百强榜">>,<<"境界">>},
%%                            {ranking_hero_fb,<<"霸主榜">>,<<"关数">>},
                           {ranking_fighting_power,<<"战力榜">>,<<"战斗力">>}
                          ]).

%%
%%================API FUCTION=======================
%%   
%%@interface 发送角色等级排行榜详细信息
send_role_all_ranking_info({Unique, Module, Method, DataIn, RoleID, PID, _Line})->
